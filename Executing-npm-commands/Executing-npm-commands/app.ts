...
var diretorioBiblioteca: string = 'C:\\Users\\Fabio\\Downloads\\Jade-Novo-Test';
var arquivoConfiguracao: string = '\\package.json';
var json: any = JSON.parse(fs.readFileSync(diretorioBiblioteca + arquivoConfiguracao, 'utf8'));
